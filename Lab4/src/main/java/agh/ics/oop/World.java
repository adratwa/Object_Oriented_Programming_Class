...
public class World {
    ...
    public static void main(String[] args) {
        //creates animal and moves it
        Animal animal1 = new Animal();
        System.out.println("Orientation and position of the animal at the beginning: " + animal1);
        animal1.move(MoveDirection.RIGHT);
        animal1.move(MoveDirection.FORWARD);
        animal1.move(MoveDirection.FORWARD);
        animal1.move(MoveDirection.FORWARD);
        System.out.println("Orientation and position od the animal after moving: right, forward, forward, forward: " + animal1);

        //creates parser and moves animal
        String[] directions = {"f", "r", "forward", "l", "x", "backward"};
        OptionParser parser = new OptionParser();
        ArrayList<MoveDirection> convertedDirections = parser.parse(directions);
        System.out.println("Converted string directions" + Arrays.toString(directions)  + "to list array: " + convertedDirections);
        for (MoveDirection direction: convertedDirections){
            animal1.move(direction);
            System.out.println("New position and orientation of the animal after moving " + direction + ": "  + animal1);
        }
